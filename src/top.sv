...
module top(input logic clk, input logic reset, input logic [31:0] cyc_cnt, output logic passed, output logic failed);
   ...
   //assign ui_in = 8'b0000001;
   
   logic ena = 1'b0;
   logic rst_n = ! reset;

   // /* is comment section. this was removed to activate this section for "user inputs"
   ...
   // */  this was end of commentj section
...
//_\TLV
   ...
   //_\source /raw.githubusercontent.com/osfpga/VirtualFPGALab/35e36bd144fddd75495d4cbc01c4fc50ac5bde6f/tlvlib/tinytapeoutlib.tlv 76   // Instantiated from top.tlv, 216 as: m5+tt_connections()
   ...
   //_\source /raw.githubusercontent.com/osfpga/VirtualFPGALab/a069f1e4e19adc829b53237b3e0b5d6763dc3194/tlvlib/fpgaincludes.tlv 307   // Instantiated from top.tlv, 219 as: m5+board(/top, /fpga, 7, $, , calc)
      ...
      //_/fpga_pins
         ...
         //_/fpga
            //_\source top.tlv 47   // Instantiated from /raw.githubusercontent.com/osfpga/VirtualFPGALab/a069f1e4e19adc829b53237b3e0b5d6763dc3194/tlvlib/fpgaincludes.tlv, 340 as: m4+calc.
               ...
               //_|calc
                  //_@0
                     // reset = $reset;   ??? what's proper syntax
                  ...
                  //_@1
                     ...
                     assign FpgaPins_Fpga_CALC_reset_or_valid_a1 = FpgaPins_Fpga_CALC_reset_a1 || FpgaPins_Fpga_CALC_valid_a1;
            
                     //from page 78 see his changes for valid and ! valid
                  ...
                  //_@2
                     ...
                     assign FpgaPins_Fpga_CALC_mem_a2[7:0] =
                        ...
                        FpgaPins_Fpga_CALC_op_a2 == 3'b101 ? FpgaPins_Fpga_CALC_out_a4 :
                                        FpgaPins_Fpga_CALC_mem_a3;
            
            
                     //$cnt[31:0] = $reset ? 32'b0 : >>1$cnt + 32'b1;
                     //$cnt = $reset ? 1'b0 : >>1$cnt + 1'b1;
                  ...
                  //_@3
                     ...
                     assign uo_out[7:0] =
                          FpgaPins_Fpga_CALC_digit_a3 == 4'h0 ? 8'b00111111:  //0
                          ...
                          FpgaPins_Fpga_CALC_digit_a3 == 4'h4 ? 8'b01100110:  //4
                          FpgaPins_Fpga_CALC_digit_a3 == 4'h5 ? 8'b01101101:  //5
                          ...
                          FpgaPins_Fpga_CALC_digit_a3 == 4'ha ? 8'b01110111:  //A
                          FpgaPins_Fpga_CALC_digit_a3 == 4'hb ? 8'b01111100:  //b
   ...
   //_\source /raw.githubusercontent.com/osfpga/VirtualFPGALab/35e36bd144fddd75495d4cbc01c4fc50ac5bde6f/tlvlib/tinytapeoutlib.tlv 82   // Instantiated from top.tlv, 221 as: m5+tt_input_labels_viz(⌈"Value[0]", "Value[1]", "Value[2]", "Value[3]", "Op[0]", "Op[1]", "Op[2]", "="⌉)
